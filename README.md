**The Bank-App is a full-stack web application** built with React and Firebase, which aims to provide users with a secure and convenient way to manage their banking needs. The application includes a range of functionalities, such as-
